  ...
  render = () =>
    <Frame>
      <div className="credits">
        ...
        <br />
        <b>Съёмка и координация в Тюмени</b><br /><ExternalLink newTab changeColor={this.props.changeColor} to="https://instagram.com/zurikova">Ирина Вадачкория</ExternalLink> и <ExternalLink newTab changeColor={this.props.changeColor} to="https://vk.com/ignatiev_e">Евгений Игнатьев</ExternalLink>
        <br />
